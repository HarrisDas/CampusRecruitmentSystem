package com.example.harri.thecampusrecruitmentsystem.AccountDetailFlow;
...
import com.example.harri.thecampusrecruitmentsystem.AccountInfoFlow.AccountInfoActivity;
...
import com.example.harri.thecampusrecruitmentsystem.AccountListFlow.CompanyListFragment;
import com.example.harri.thecampusrecruitmentsystem.AccountListFlow.StudentListFragment;
...
public class AccountDetailActivity extends AppCompatActivity{
    ...
    private TextView companyDetailJobInfo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //   Glide.with(getApplicationContext()).load(companyInfo.getCompanyURL()).asBitmap()
         //           .error(R.drawable.default_company_image).centerCrop().into(userDetailImage);
            ...
            companyDetailJobInfo.setText(companyInfo.getCompanyJobInfo());
    ...
    public void attachingWidgets(){
        ...
        companyDetailJobInfo=(TextView)findViewById(R.id.company_detail_job_info);
    ...
    public void onBackPressed() {
        super.onBackPressed();
Intent i = new Intent(AccountDetailActivity.this,AccountListActivity.class);

      i.putExtra("memberType",membershipType);
        startActivity(i);
        finish();
    }
}
